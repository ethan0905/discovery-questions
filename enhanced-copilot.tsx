...
export default function EnhancedCopilot() {
  // OpenAI theme colors
  ...
  // Question titles and emojis
  const questionTitles = [
    { emoji: "🧊", title: "Ice Breaker" },
    { emoji: "🔍", title: "Previous Solutions" },
    { emoji: "🎯", title: "Success Definition" },
    { emoji: "👥", title: "Stakeholders" },
    { emoji: "⏱️", title: "Timeline" },
    { emoji: "💰", title: "Budget" },
    { emoji: "🚀", title: "Next Steps" },
  ]
  ...
  const getQuestionColor = (index: number) => {
    ...
    if (index === questions.length - 1) return nextStepOrange
    return openaiAccent
  }
                ...
                >
                  <div className="flex-1">
                    {isActive && (
                      ...
                      >
                        {questionTitles[index].emoji} {questionTitles[index].title}
                      </div>
                    )}
                    <div
                      style={{
