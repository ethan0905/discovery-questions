...
export default function RefinedAnimatedCopilot() {
  // OpenAI theme colors
  ...
  // Hover color (stronger gray)
  const hoverGray = "#E5E5E5"
              ...
              return (
                <motion.div
                  ...
                  className={`p-3 rounded-md ${bgColor} ${isActive ? `border ${borderColor}` : ""} ${
                    !isActive ? "cursor-pointer hover:bg-[#E5E5E5] transition-colors duration-150" : ""
                  }`}
