...
export default function LargeTextCopilot() {
  // Custom colors
                  ...
                  >
                    <div className="flex items-start gap-2">
                      {isActive && (
                        <>
                          {isNextStep ? (
                            <Flag className="h-7 w-7 mt-1 flex-shrink-0" style={{ color: nextStepOrange }} />
                          ) : (
                            <ChevronRight
            ...
            {isCompleted && (
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-xl font-medium" style={{ color: customGreen }}>
                    Discovery Complete
                  </h3>
                </div>
